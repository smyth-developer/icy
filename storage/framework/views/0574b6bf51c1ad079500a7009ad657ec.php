...
$__html = app('livewire')->mount($__name, $__params, 'lw-3242540345-0', $__slots ?? [], get_defined_vars());
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-xs text-gray-500 dark:text-gray-400">ID: <?php echo e($student->id); ?></div>
                                        </div>
                                    </div>
                                </td>
...
<?php endif; ?>
                                            <!--[if BLOCK]><![endif]--><?php if(!$loop->last): ?> <br> <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
...
</div><?php /**PATH /Users/smyth/Herd/icy/resources/views/livewire/back/personnel/registration/students-registration.blade.php ENDPATH**/ ?>
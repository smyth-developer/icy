    ...
    <flux:modal :dismissible="false" name="modal-program" class="md:w-900">
        <form wire:submit='{{ $isEditProgramMode ? 'updateProgram' : 'createProgram' }}' class="space-y-6">
            <div>
                ...
                <flux:text class="mt-2">{{ $isEditProgramMode ? 'Chỉnh sửa thông tin chương trình học' : 'Thêm mới chương trình học' }}.
                </flux:text>
            </div>
            ...
            <div class="form-group">
                <flux:textarea wire:model='description' placeholder="Nhập thông tin chương trình áp dụng cho ai?" label="Mô tả chương trình"></flux:textarea>
            </div>
